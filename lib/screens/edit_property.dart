...
class _EditPropertyPageState extends State<EditPropertyPage> {
  ...
  final TextEditingController secondBrokerNameController = TextEditingController();
  ...
  Future<void> _loadProperty() async {
    ...
    if (doc.exists) {
      ...
      setState(() {
        ...
        keysOption = data["keys"] ?? "Direct";
        _viaSecondBroker = data["viaSecondBroker"] ?? false;

        projectNameController.text = data["projectName"] ?? "";
        unitNoController.text = data["unitNo"] ?? "";
        bhkController.text = data["bhkOrSqft"] ?? "";
        priceController.text = data["price"] ?? "";
        ownerNameController.text = data["ownerName"] ?? "";
        ownerNumberController.text = data["ownerNumber"] ?? "";
        brokerNameController.text = data["brokerName"] ?? "";
        secondBrokerNameController.text = data["secondBrokerName"] ?? "";
  ...
  Future<void> _updateProperty() async {
    if (_formKey.currentState!.validate()) {
      ...
      await FirebaseFirestore.instance
        ...
        "keys": keysOption,
        if (withBroker) "brokerName": brokerNameController.text,
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              // Broker Name — only when "With Broker"
              if (withBroker) ...[
                TextFormField(
              ...
              if (_viaSecondBroker) ...[
                ...
                TextFormField(
                  ...
                  validator: (value) =>
                      _viaSecondBroker && (value == null || value.trim().isEmpty)
